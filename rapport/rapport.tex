...
Il faudra aussi s'assurer que la partie logique du site soit stockée du coté serveur et de n'envoyer à la machine de l'utilisateur que les informations auquelles il est supposé avoir accès.\\
...
Pour faciliter l'utilisation du site aux utilisateurs et éviter qu'ils ne se retrouvent perdus, ils sera important dans le design des pages du site, de s'assurer de bien disposer les informations essentielles au centre et en haut de la page, afin que ce soit la première chose que l'utilisateur voit sans avoir besoin de scroller.\\

Il est important que l'utilisateur n'ait pas à ce demander ce que l'on attend de lui, dès l'instant ou il pose ses yeux sur la page, ce qu'il doit faire est clair.\\
...
Il faudra en même temps éviter de surcharger ce haut de page, et de n'y laisser que les informations essentielles, afin d'éviter de surcharger l'utilisateur d'informations.\\
