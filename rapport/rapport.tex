...
\begin{itemize}
    ...
    \item un id_createur qui permet de retrouver les informations de l'utilisateur ayant créé l'annonce.
    \item un id_categorie qui permet de retrouver la catégorie de l'annonce.
\end{itemize}
...
\begin{itemize}
    ...
    \item Un id_auteur permettant de retrouver les informations de l'utilisateur ayant créé le message.
\end{itemize}
...
Pour faciliter le test aux enseignants, nous avons créé des comptes avec des éléments pré remplies comme une annonce, quelques réponses, etc...\\
