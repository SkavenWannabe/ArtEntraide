...
Pour pouvoir tester et évaluer notre site, nous l'avons fait tester à des membre de notre familles, à des amis, en bref, à la plus grande diversité de profils de personne. Pour avoir une continuité et stabilité dans l'évaluation, nous nous sommes basé sur les critère ergonomique de Bastien et Scapin pour notre grille d'evaluation. Elle comprend donc : Le guidage, le contrôle explicite, la gestion d'errur, la charge de travail et l'homogeneité. Cependant, en ce qui concerne l'adaptabilité, nous avons decidé de ne pas en tenir rigeur pour garder une simplicité optimale. En ce qui concerne les autres élement nous avons demander aux testeur d'attribuer une note sur dix par categorie.\\
Cela nous donne une moyenne général de X/10 avec :\\
\begin{itemize}
  \item Guidage : X/10
...
Nous avons aussi rédigé un petit sénario à suivre lors de l'évauation tel que :
\begin{enumerate}
  \item Rechercher une annonce existante en base
  \item Tenter d'y repondre (ce qui est impossible sans être connecté)
  \item Crée un compte
  \item Repondre a l'annonce rechercher plutôt
