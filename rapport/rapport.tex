...
Pour le 24 Novembre 2020 :
création d'annonces
\begin{itemize}
  \item Support d’une centaine d’inscrits.
  \item Support d’une centaine d’annonces.
\end{itemize}

Pour le 15 Janvier 2021 :
\begin{itemize}
  \item Avoir une interface utilisateur facile d'accès, évaluée grâce aux questionnaire SUS.
  \item Effectuer des tests approfondis des fonctionnalités.
\end{itemize}
