...
Un voisinage etant un des meilleur example de mixité social.
Il y à des jeune, des vieux, des ouvrier, des ingénieurs, des familles, autant de personnes qui sont plus ou moins à l'aise en informatique.
C'est à nous de nous adapter à tout ses différents niveau. Il faut donc que le site soit simple et facile d'utilisation.
Pour atteindre cette objectif on peut faire un guidage sur le site, suivre les règles d'accecibilité de W3C et faire une foire aux questions par example.\\


\subsubsection{Des utilisateurs de confiances}

Celon les services on peut avoir besoin d'utilisateur de confiance.
Par example pour des travaux de plomberie il faut quelqu'un capable de réparer et surtout de ne pas empirer les dégats.
Ou encore, pour les personne agés, il faut que les personnes qui intervienne au domicile ne soit pas mal intentionnée.
Il faut donc un moyen de certifier les utilisateur.
...
\begin{figure}[H]
  \includegraphics[width=\linewidth]{images/figure-1.png}
