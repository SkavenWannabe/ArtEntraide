...
\begin{itemize}
  \item \href{https://www.allovoisins.com/}{AlloVoisins} : propose un service de mise en relation entre particuliers avec 3,5 millions
  ...
  \item \href{https://pwiic.com/fr/}{Pwiic} : c’est un site qui permet d’échanger des services ou objets auprès de particuliers. Il suffit
  d’envoyer un “Pwiic” pour que la demande s’affiche sur le site. Un algorithme se charge de
  l’envoyer aux bonnes personnes.

  \item \href{http://www.yakasaider.fr/}{YakaSaider} : c’est un site communautaire qui met en relation des particuliers ayant besoin ou
