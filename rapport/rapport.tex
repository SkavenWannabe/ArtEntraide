...
La priorité parmis les different type de certification à été la certification par un tiers. Un utilisateur certifié ce reconnais grâce à un badge attypique à la suite de son prénom.\\

Le système de réputation étant secondaire n'a été implanté que partiellent et est, à l'heure acctuel, non fonctionnels. Cependant, il reste dans notre liste de priorité si nous voulons achever le site entièrement.
...
Actuellement, les deux types de compte existant sont les comptes utilisateurs et les comptes certificateurs. Les comptes utilisateurs sont créés via la page d'inscription et correspondent à un utilisateur lambda, mais les comptes certificateurs sont gérer par une autorité de certification des utilisateurs tels qu'une mairie ou une association.
Les comptes certificateurs, eux, sont créés directement en base de donnée pour l'instant. Cette pratique peut poser des problèmes tels qu'une mauvaise saisie ou une erreur via le langage SQL. C'est pour cela que, à terme nous ferons un compte "administrateur" avec la possibilité de créer des comptes certificateurs et des outils de modération tel que le bannissement temporaire ou permanant de membres.
Si l'affluence du site devient importante nous devrons créer des comptes modérateurs pour sanctionner des abus d'annonce ou de membre.\\
...
% ---------- secutite ----------
\subsection{Sécurité}
Nôtre site étant en phase de prototype, la sécurité n'est pas maximale.  Notamment au niveau de la gestion de mot de passe qui est, pour l'instant, entrée en clair dans la base de donnée. L'une des solutions est de hacher les mot de passe avant chaque acces en base (pour les entrer ou les comparer) pour que même si il y a une fuite de sécurité, l'impact soit limité. Cependant, pour maintenir l'intégrité du site, certains faille on été corrigé comme les injections de code ou encore le protocole qui à été passé en https.
...
\begin{center}
   \begin{tabular}{ | l | c | c | c | c | c | c | }
     ...
     Florian attias  & 8,3/10 & 7/10       & 8/10   & 8/10    & non evalué & 8/10    \\ \hline
     Frederic Loraux & 8/10   & non evalué & 9/10   & 9/10    & 9/10       & 10/10   \\ \hline
     Sarah Loraux    & 9.5/10 & non evalué & 10/10  & 10/10   & 10/10      & 10/10   \\ \hline
     Total           & 8.3/10 & 7/10       & 8.5/10 & 8.75/10 & 9.3/10     & 9.25/10 \\ \hline
