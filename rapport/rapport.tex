...
Afin de mettre en relation les particuliers, le site permettra la création et d'"annonces", correspondant à un quelqu'un recherchant ou proposant un service.\\

Ces annonces seront accesibles à la consultation au public et les utilisateurs souhaitant répondre à l'annonce (parce qu'il proposent ou demandent un service similaire à l'annonce) pourront être directement mis en contact avec l'auteur de l'annonce.
