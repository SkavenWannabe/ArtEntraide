...
Pour mieux comprendre les fontionnalités et les besoins auxquels nous devons répondre, nous avons créé un diagramme de cas d'utilisations.
...
A titre d’exemple, voici une pages qui préfigure l’ergonomie qui s’appliquera
au le site. Les maquettes et leur discussion se trouve en \underline{\hyperref[sec:maquettes-annexe]{annexe}}. Les différentes pages doivent rester
...
\begin{itemize}
  ...
  \item Cohérence interne : pour que l'utilisateur puisse apprendre plus rapidement à utiliser le site,
  les pages doivent se ressembler le plus possible. Dans ce sens, l'en-tête et le pied de page sont communs à toutes
  les pages du site.
  \item Flexibilité : pour faciliter l'utilisation du site, il y aura souvent plusieurs moyen
...
modèle MVC. Le diagramme ci-dessous correspond à la création d'une annonce. En \underline{\hyperref[fig:ds-connexion]{annexe}} se trouve le
diagramme correspondant à l'authentification.
